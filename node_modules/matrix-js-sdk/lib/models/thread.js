...
class Thread extends _typedEventEmitter.TypedEventEmitter {
  ...
  constructor(rootEvent, opts) {
    ...
    (0, _defineProperty2.default)(this, "onBeforeRedaction", event => {
      var _this$lastEvent;

      if (event !== null && event !== void 0 && event.isRelation(THREAD_RELATION_TYPE.name) && this.room.eventShouldLiveIn(event).threadId === this.id) {
        this.replyCount--;
        this.emit(ThreadEvent.Update, this);
      }

      if (((_this$lastEvent = this.lastEvent) === null || _this$lastEvent === void 0 ? void 0 : _this$lastEvent.getId()) === event.getId()) {
        var _events$find;

        const events = [...this.timelineSet.getLiveTimeline().getEvents()].reverse();
        this.lastEvent = (_events$find = events.find(e => !e.isRedacted() && e.getId() !== event.getId() && e.isRelation(THREAD_RELATION_TYPE.name))) !== null && _events$find !== void 0 ? _events$find : this.rootEvent;
  ...
  findEventById(eventId) {
    ...
    if (((_this$lastEvent2 = this.lastEvent) === null || _this$lastEvent2 === void 0 ? void 0 : _this$lastEvent2.getId()) === eventId) {

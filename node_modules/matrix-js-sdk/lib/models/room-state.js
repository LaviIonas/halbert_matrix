...
class RoomState extends _typedEventEmitter.TypedEventEmitter {
  ...
  setStateEvents(stateEvents) {
    ...
    stateEvents.forEach(event => {
      ...
      if ((0, _beacon.isBeaconInfoEventType)(event.getType())) {
  ...
  onBeaconLivenessChange() {
    var _this$liveBeaconIds2;

    const prevHasLiveBeacons = !!((_this$liveBeaconIds2 = this.liveBeaconIds) !== null && _this$liveBeaconIds2 !== void 0 && _this$liveBeaconIds2.length);
    this.liveBeaconIds = Array.from(this.beacons.values()).filter(beacon => beacon.isLive).map(beacon => beacon.beaconInfoId);
